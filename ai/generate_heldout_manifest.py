...
def main():
    ...
    baseline_path = (
        root / "ai/build/reports/naver-place-pipeline/komsco-i0000002-baseline-50-stable.manifest"
    )
    baseline_ids = set()
    ...
    # 3. Filter population
    candidates = [
        ref for ref in population.references if ref.external_merchant_id not in baseline_ids
    ]
    ...
    out_path = (
        root
        / "ai/build/reports/naver-place-pipeline/qwen3.5-provider-fusion-heldout-50-v2.manifest"
    )
