"""Provider·Place ID·Detail의 차단 신호와 제한 재시도 계약을 검증한다."""

import pytest

from app.batch.place_request_limiter import TransientRetryPolicy
from app.entity_resolution.provider_entity_resolution_cli import _blocked_provider_error
from app.naver.place_detail_enrichment_cli import _is_blocked_error as detail_blocked
from app.naver.place_id_linker_cli import _is_blocked_error as linker_blocked
