"""수동 Place pipeline의 제어·rate limit 경계를 외부 호출 없이 검증한다."""

import csv

from app.batch.place_request_limiter import NavigationRateLimiter
from app.naver import place_pipeline_cli as pipeline
from app.naver.place_resolver import ResolutionStatus, RestaurantReference
